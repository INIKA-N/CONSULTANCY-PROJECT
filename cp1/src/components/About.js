    ...
    return(
        ...
        <div className='about'>
            ...
            <div className='about2'>
                    <div className='abo'>
                            <h1><span style={{ color:'  rgba(7, 154, 246, 0.9)'}}>10+ years </span>of expertise</h1>
                            <br></br>
                            <p>
                            Instituted in the year <span style={{ color:'  rgba(7, 154, 246, 0.9)'}}>of 1995,Sathyam Traders</span> is in the line of work of manufacturing and trading of first rate products emphasizing on high strength, durability and long lastingness with high resistance to impact. We are deep-rooted with providing top-notch quality for customer contentment.
